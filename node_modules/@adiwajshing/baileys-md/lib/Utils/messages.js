...
exports.getDevice = exports.extractMessageContent = exports.generateWAMessage = exports.generateWAMessageFromContent = exports.generateWAMessageContent = exports.generateForwardMessageContent = exports.prepareDisappearingMessageSettingContent = exports.prepareWAMessageMedia = void 0;
...
const prepareWAMessageMedia = async (message, options) => {
    ...
    const { mediaUrl, directPath } = await options.upload(fs_1.createReadStream(encBodyPath), { fileEncSha256B64, mediaType, timeoutMs: options.mediaUploadTimeoutMs });
    // remove tmp files
    await Promise.all([
