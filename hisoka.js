...
module.exports = hisoka = async (hisoka, m, chatUpdate) => {
	...
	const isBotAdmins = m.isGroup ? groupAdmins.includes(m.sender) : false
        ...
        switch(command) {
	    case 'sc': {
                 m.reply('Script : https://github.com/rifqikhanif\n\n Dont Forget Give Star\n\nDonate : https://wa.me/6285349947480\n\n Dont Forget Donate')
            }
            break
            case 'chat': {
...
${cpus.map((cpu, i) => `${i + 1}. ${cpu.model.trim()} (${cpu.speed} MHZ)\n${Object.keys(cpu.times).map(type => `- *${(type + '*').padEnd(6)}: ${(100 * cpu.times[type] / cpu.total).toFixed(2)}%`).join('\n')}`).join('\n\n')}` : ''}
            ...
            case 'owner': case 'creator': {
                let vcard = 'BEGIN:VCARD\n' // metadata of the contact card
                    ...
                    + 'TEL;type=CELL;type=VOICE;waid=6285349947480:+62 853-4994-7480\n' // WhatsApp ID + phone number
                    + 'END:VCARD'
                        ...
                        hydratedTemplate: {
                            ...
                            hydratedButtons: [{
                                urlButton: {
                                    ...
                                    url: 'https://github.com/rifqikhanif'
                                }
                            }, {
                                callButton: {
                                    displayText: 'Number Phone Owner',
                                    phoneNumber: '+62 853-4994-7480'
                                }
                            }, {
                                quickReplyButton: {
